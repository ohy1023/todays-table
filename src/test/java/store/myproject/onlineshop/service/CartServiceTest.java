...
//        // given
//        CartAddRequest request = new CartAddRequest(item.getId(), 2L);
...
//        // given
//        CartAddRequest request = new CartAddRequest(item.getId(), 100L);
//
//        given(customerRepository.findByEmail(customer.getEmail())).willReturn(Optional.of(customer));
//        given(cartRepository.findByCustomer(customer)).willReturn(Optional.of(cart));
//        given(itemRepository.findById(item.getId())).willReturn(Optional.of(item));
...
//        // given
//        CartAddRequest request = new CartAddRequest(item.getId(), 1L);
...
//        // given
//        CartAddRequest request = new CartAddRequest(999L, 1L);
//
//        given(customerRepository.findByEmail(customer.getEmail())).willReturn(Optional.of(customer));
//        given(cartRepository.findByCustomer(customer)).willReturn(Optional.of(cart));
...
//
//        // when
//        MessageResponse response = cartService.deleteItemFromCart(item.getId(), customer.getEmail());
//
//        // then
...
//
//        // when & then
//        assertThatThrownBy(() -> cartService.deleteItemFromCart(999L, customer.getEmail()))
//                .isInstanceOf(AppException.class)
//                .hasMessage(ErrorCode.ITEM_NOT_FOUND.getMessage());
//    }
//}