...
//        );
//
//        given(memberShipService.selectAll()).willReturn(response);
//
//        // when & then: GET 요청을 수행하고 응답을 검증
...
//        MemberShipDto response = MemberShipFixture.createBronzeDto();
//
//        given(memberShipService.saveMemberShip(request)).willReturn(response);
//
//        // when & then
...
//                .andExpect(jsonPath("$.result.baseline").value(response.getBaseline()))
//                .andExpect(jsonPath("$.result.discountRate").value(response.getDiscountRate()))
//                .andExpect(jsonPath("$.result.level").value(response.getLevel().name()))
//                .andDo(print());
//    }
//
//    @Test
...
//        MemberShipCreateRequest request = MemberShipFixture.createBronzeRequest();
//
//        given(memberShipService.saveMemberShip(any()))
...
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$.resultCode").value(SUCCESS))
//                .andExpect(jsonPath("$.result.msg").value("삭제 완료"));
//    }
//
//
//    @Test
