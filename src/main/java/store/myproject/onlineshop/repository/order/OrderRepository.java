...
public interface OrderRepository extends JpaRepository<Order, Long>, OrderCustomRepository {
    ...
    @Query("select o from Order o join fetch o.delivery d join fetch o.orderItemList oi join fetch oi.item i join fetch i.brand b where o.merchantUid = :merchantUid and o.orderStatus in (store.myproject.onlineshop.domain.order.OrderStatus.ORDER, store.myproject.onlineshop.domain.order.OrderStatus.CANCEL) and o.customer = :customer")
