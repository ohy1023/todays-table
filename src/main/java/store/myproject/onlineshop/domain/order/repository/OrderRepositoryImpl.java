...
import static store.myproject.onlineshop.domain.delivery.QDelivery.*;
import static store.myproject.onlineshop.domain.item.QItem.item;
import static store.myproject.onlineshop.domain.order.QOrder.*;
import static store.myproject.onlineshop.domain.orderitem.QOrderItem.*;
