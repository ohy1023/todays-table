...
public class OrderInfoRequest {
    ...
    @Schema(description = "주문할 상품 UUID", example = "13dd3e84-2b3a-11f0-9aef-59f7f88a8400", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "주문할 상품 수량", example = "2", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "배송지 도시", example = "서울시", requiredMode = Schema.RequiredMode.REQUIRED)
    private String recipientCity;

    @NotNull(message = "도로명 주소는 필수입니다.")
    @Schema(description = "배송지 도로명 주소", example = "강남대로 123", requiredMode = Schema.RequiredMode.REQUIRED)
    private String recipientStreet;

    @NotNull(message = "상세 주소는 필수입니다.")
    @Schema(description = "배송지 상세 주소", example = "101동 202호", requiredMode = Schema.RequiredMode.REQUIRED)
    private String recipientDetail;

    @NotNull(message = "우편번호는 필수입니다.")
    @Schema(description = "배송지 우편번호", example = "06236", requiredMode = Schema.RequiredMode.REQUIRED)
